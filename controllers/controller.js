...
function addWheels(brand, diameter) {
    ...
    for (var i_2 = 0; i_2 < 4; i_2++) {
        ...
        if (dmts[i_2] >= 0.4 && dmts[i_2] <= 2) {
            ...
            (document.getElementById("dmtwheel" + (i_2 + 1)).value) = "";
            var error = document.getElementById("errorDmt" + (i_2 + 1));
            error.style.visibility = "visible";
    ...
    for (var i = 0; i < 4; i++) {
        var wheelNumber_1 = i + 1;
        var dmtDisplay = document.getElementById("wheelDmt" + wheelNumber_1);
        dmtDisplay.textContent = car.wheels[i]["diameter"];
    }
    for (var i = 0; i < 4; i++) {
        var wheelNumber_2 = i + 1;
        var brandDisplay = document.getElementById("wheelBrand" + wheelNumber_2);
